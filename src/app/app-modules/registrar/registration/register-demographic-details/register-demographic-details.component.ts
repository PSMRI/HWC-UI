  ...
  implements OnInit, DoCheck, OnDestroy
{
  ...
  configState() {
    ...
    this.registrarService.stateIdFamily =
      this.revisitData.i_bendemographics.m_state.stateID;
  }
  /**
  ...
  loadState() {
    ...
    this.registrarService.stateIdFamily =
      this.demographicsMaster.otherLoc.stateID;
  }
  ...
  chooseLocations() {
    return [{ id: 3, name: this.currentLanguageSet.ro.locInfo.state }];
  }
  ...
  confirmEditDemographics(event: any) {
    ...
    if (event.checked === true) {
      ...
      this.confirmationService
        .confirm(
          `info`,
          this.currentLanguageSet.alerts.info.RemoveTheChanges,
          'Yes',
          'No',
        )
        .subscribe((res) => {
